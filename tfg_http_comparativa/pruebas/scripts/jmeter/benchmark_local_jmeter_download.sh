...
ORIGINAL_JMX="../../../resultados/datos/comparativa_http_download.jmx"
# ARCHIVO INTERMEDIO
DATOS_FILTRADOS="../../../resultados/datos/latencia_download.jmx"
# ARCHIVO PARA GNUPLOT
GNUPLOT_SCRIPT="../gnuplot/grafica_latencia.gp"
...
set output "../../../resultados/graficas/grafica_latencia_download.png"
...
echo "Gráfica generada: grafica_latencia_download.png"