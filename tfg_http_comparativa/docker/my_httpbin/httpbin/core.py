...
template = {
    ...
    "tags": [
        ...
        {"name": "Downloads", "description": "Returns a file (add /download at the end of the URL to try out this feature)"},
    ],
}
...
def download():
    ...
    """
    return send_file("static/sample_5mb.bin", as_attachment=True)
